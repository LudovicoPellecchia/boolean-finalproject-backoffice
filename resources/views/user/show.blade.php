...
@section('content')
    ...
    <div class="row ">
        <div class="col-lg-4 col-12 categories-bg ">
            ...
            <div class="col-md-12">
                <div class="card-body">
                        <p class="col-12 description text-justify"> Benvenuto nella pagina dei Dettagli del tuo Profilo. Questo spazio
                            è
                            ...
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <div class="profile-photo p-3">
                                        <img class="card-img-top text-center" src="{{ asset('storage/' . $profile->photo) }}"
                                            alt="">
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body ps-5">
                                        ...
                                        <div class="col-6">
                                            <ul class="list-unstyled">
                                                <li class="color-site fs-4"><strong>Telefono:</strong></li> <h5>{{ $profile->phone }}</h5>
                                        ...
                                        {{-- ----------- modifica e cancella ---------- --}}
                                            ...
                                            <div class="row text-center pt-5 gap-4">
                                                <div class="col-12 col-lg-5">
                                                    <a href="{{ route('user.edit', $profile->id) }}" class="btn btn-primary ps-5 pe-5 pt-2 pb-2">Modifica</a>
                                                </div>
